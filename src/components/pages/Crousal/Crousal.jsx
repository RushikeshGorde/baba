          ...
          <div className="container">
            <div className='row'>
              <div className='col-12 col-md-7 d-flex align-items-center p-0'>
                ...
                {/* <button className='bg-info fw-bold p-2 rounded border-0'>
                  <a href="/front" target="_self"> Konw More</a>
                </button> */}
                <div className='text-end'>
                <button className='allbtn bg-info fw-bold p-2 rounded border-0'> <a href="/front" target="_self"> Konw More </a></button>
                </div>
                </div>
