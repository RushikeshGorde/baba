                        ...
                        <div className="info-column col-md-4 col-sm-12 col-xs-12">
                            <div className="inner-column">
                                ...
                                <ul className="list-info">
                                    <li><i className="fas fa-globe"></i><span className="info-text">Mumbai</span></li>
                                    <li><i className="far fa-envelope"></i><a className="info-link" href="mailto:techlogicwaveinfo@gamil.com">Email Us</a></li>
                                ...
                                <li className="d-flex border-right">
                                        ...
                                        <Link className="nav-link text-white " to={'https://x.com/soulmate_info?t=h2XePHqsulUArZNtmGkkew&s=09'}>
                                            <i className="fab fa-twitter twiter me-2"></i>
                                        </Link>
                                        <Link className="nav-link text-white" to={'https://www.youtube.com/'}>
                                            <i className="fab fa-youtube yt me-2"></i>
                                        </Link>
                                        <Link className="nav-link text-white" to={'https://www.linkedin.com/company/soulmate-infotech05/?viewAsMember=true'}>
                                            <i className="fab fa-linkedin-in linked me-2"></i>
                                        </Link>
                                        <Link className="nav-link text-white" to={'https://www.instagram.com/soulmate_infotech?igsh=dWZsOHpkdHpodHFk'}>
